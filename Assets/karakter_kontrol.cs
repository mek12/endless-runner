...
public class karakter_kontrol : MonoBehaviour {
    ...
    void Update ()
    {
        ...
        if (sag==true)
        {
            transform.position = Vector3.Lerp(transform.position, new Vector3(-1.0f, transform.position.y, transform.position.z), kosma_hizi * Time.deltaTime);
        }
        if (sol == true)
        {
            transform.position = Vector3.Lerp(transform.position, new Vector3(1.75f, transform.position.y, transform.position.z), kosma_hizi * Time.deltaTime);
        }
